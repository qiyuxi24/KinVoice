...
<<<<<<< HEAD
async def update_dynamic(req: ProfileUpdateRequest):
=======
...
>>>>>>> si
    ...
    """
<<<<<<< HEAD
    logger.info(f"动态档案更新请求: user_id={req.user_id}")

    try:
        messages = await _message_source.fetch_today_messages(req.user_id)
=======
...
<<<<<<< HEAD
    result = await update_dynamic_profile(req.user_id, messages)
=======
...
<<<<<<< HEAD
async def update_stable(req: ProfileUpdateRequest):
=======
...
>>>>>>> si
    ...
    """
<<<<<<< HEAD
    logger.info(f"固定档案更新请求: user_id={req.user_id}")
...
<<<<<<< HEAD
    result = await update_stable_profile(req.user_id, messages)
=======
...
<<<<<<< HEAD
async def read_profile(user_id: str = "default"):
    """
